  ...
  internal = rec {
    ...
    crates = {
      ...
      "async-sse" = rec {
        ...
        version = "2.1.0";
        edition = "2018";
        sha256 = "1cskq211yj6173zis1w3y5430da6chc89j7l20mv71qjvna35rvd";
        authors = [
      ...
      "isahc" = rec {
        ...
        version = "0.9.3";
        edition = "2018";
        sha256 = "1hj9wljs3s3p8rc9kwhri0rxhab0kncha0c1j9r6d6va2yv4g309";
        authors = [
      ...
      "packet-exporter" = rec {
        crateName = "packet-exporter";
        version = "0.1.0";
        edition = "2018";
        crateBin = [
          { name = "packet-exporter"; path = "src/main.rs"; }
        ];
      ...
      "surf" = rec {
        ...
        edition = "2018";
        sha256 = "1zsnnvp0vhf6hyhbn8y46f6pfii9i7fmxzpi2backci498nk0b6p";
        authors = [
          "Yoshua Wuyts <yoshuawuyts@gmail.com>"
          "dignifiedquire <me@dignifiedquire.com>"
        ];
        ...
        resolvedDefaultFeatures = [ "curl-client" "default" "encoding" "encoding_rs" "middleware-logger" "native-client" "wasm-client" "web-sys" ];
      };
      "syn" = rec {
        crateName = "syn";
        version = "1.0.28";
        edition = "2018";
        sha256 = "00qcp6skvi90xmg35p746nzrni9bz62x7hf93cmc0g8dy9i3mqz7";
        authors = [
          "David Tolnay <dtolnay@gmail.com>"
        ];
        dependencies = [
      ...
      "tide" = rec {
        ...
        version = "0.8.1";
        edition = "2018";
        sha256 = "169aj7klsznysml1jxpwc8m2cnkrfyvd1n1b02c18xiwzvr5m5fg";
        authors = [
          "Aaron Turon <aturon@mozilla.com>"
          "Yoshua Wuyts <yoshuawuyts@gmail.com>"
        ];
      ...
      "winapi 0.3.8" = rec {
        ...
        resolvedDefaultFeatures = [ "errhandlingapi" "fileapi" "handleapi" "libloaderapi" "lmcons" "minschannel" "minwinbase" "minwindef" "ntdef" "ntstatus" "processthreadsapi" "profileapi" "schannel" "securitybaseapi" "sspi" "std" "sysinfoapi" "timezoneapi" "winbase" "wincrypt" "winerror" "winnt" "winsock2" "ws2def" "ws2ipdef" "ws2tcpip" ];
      };
      "winapi-build" = rec {
